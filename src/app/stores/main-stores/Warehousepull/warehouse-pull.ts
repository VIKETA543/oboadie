...
import { Component, Inject, OnInit, PLATFORM_ID, Signal, inject, signal } from '@angular/core';
...
@Component({
  ...
  imports: [DialogModule,
    ...
    ,
  templateUrl: './warehouse-pull.html',
  styleUrl: './warehouse-pull.scss',
  providers: [MessageService]
})
export class WarehousePull implements OnInit {
...
loading=signal(false);
  ...
  userData: any
    credentials: any
  constructor(@Inject(PLATFORM_ID) private platformId: Object,private storeservice: StoreService,) {
